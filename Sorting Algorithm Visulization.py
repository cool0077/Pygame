...
class DrawInformation:
    ...
    FONT = pygame.font.SysFont('comicsana', 30)
...
def draw(draw_info, algo_name, ascending):
    ...
    sorting = draw_info.FONT.render("I - Inserting Sort | B - Bubble Sort" , 1, draw_info.BLACK)
...
def inseration_sort(draw_info, ascending=True):
    lst = draw_info.lst
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.key == pygame.K_r:
                ...
                sorting_algorithm = inseration_sort
                sorting_algo_name = "Inseration Sort"
